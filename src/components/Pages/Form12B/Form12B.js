...
import { FileUploadedHandler, Form12BHanlder, GetSingleResponse } from '../../../Redux/Actions/ResponseAction';
...
const having_arrear_f = useRef();

useEffect(()=>{
    if(response!==undefined && response!==null){
 
      having_arrear_f.current.value = response.having_arrear_f;
       basic1.      current.value =    response.basic_f1;
        rate1.       current.value =    response.rate_f1;
          da1.         current.value =    response.da_f1;
         hra1.        current.value =    response.hra_f1;
          ma1.         current.value =    response.ma_f1;
       gross1.      current.value =    response.gross_f1;
        ptax1.       current.value =    response.ptax_f1;
        aupf1.       current.value =    response.aupf_f1;
          sf1.         current.value =    response.sf_f1;
      income1.     current.value =    response.income_f1;
      netsal1.     current.value =    response.netsal_f1;      
     basic2.      current.value =    response.basic_f2;
      rate2.       current.value =    response.rate_f2;
        da2.         current.value =    response.da_f2;
       hra2.        current.value =    response.hra_f2;
        ma2.         current.value =    response.ma_f2;
     gross2.      current.value =    response.gross_f2;
      ptax2.       current.value =    response.ptax_f2;
      aupf2.       current.value =    response.aupf_f2;
        sf2.         current.value =    response.sf_f2;
    income2.     current.value =    response.income_f2;
    netsal2.     current.value =    response.netsal_f2;
   basic3.      current.value =    response.basic_f3;
    rate3.       current.value =    response.rate_f3;
      da3.         current.value =    response.da_f3;
     hra3.        current.value =    response.hra_f3;
      ma3.         current.value =    response.ma_f3;
   gross3.      current.value =    response.gross_f3;
    ptax3.       current.value =    response.ptax_f3;
    aupf3.       current.value =    response.aupf_f3;
      sf3.         current.value =    response.sf_f3;
  income3.     current.value =    response.income_f3;
  netsal3.     current.value =    response.netsal_f3;
       basic4.      current.value =    response.basic_f4;
        rate4.       current.value =    response.rate_f4;
          da4.         current.value =    response.da_f4;
         hra4.        current.value =    response.hra_f4;
          ma4.         current.value =    response.ma_f4;
       gross4.      current.value =    response.gross_f4;
        ptax4.       current.value =    response.ptax_f4;
        aupf4.       current.value =    response.aupf_f4;
          sf4.         current.value =    response.sf_f4;
      income4.     current.value =    response.income_f4;
      netsal4.     current.value =    response.netsal_f4;
  
       basic5.      current.value =    response.basic_f5;
        rate5.       current.value =    response.rate_f5;
          da5.         current.value =    response.da_f5;
         hra5.        current.value =    response.hra_f5;
          ma5.         current.value =    response.ma_f5;
       gross5.      current.value =    response.gross_f5;
        ptax5.       current.value =    response.ptax_f5;
        aupf5.       current.value =    response.aupf_f5;
          sf5.         current.value =    response.sf_f5;
      income5.     current.value =    response.income_f5;
      netsal5.     current.value =    response.netsal_f5;
      
  
       basic6.      current.value =    response.basic_f6;
        rate6.       current.value =    response.rate_f6;
          da6.         current.value =    response.da_f6;
         hra6.        current.value =    response.hra_f6;
          ma6.         current.value =    response.ma_f6;
       gross6.      current.value =    response.gross_f6;
        ptax6.       current.value =    response.ptax_f6;
        aupf6.       current.value =    response.aupf_f6;
          sf6.         current.value =    response.sf_f6;
      income6.     current.value =    response.income_f6;
      netsal6.     current.value =    response.netsal_f6;
       basic7.      current.value =    response.basic_f7;
        rate7.       current.value =    response.rate_f7;
          da7.         current.value =    response.da_f7;
         hra7.        current.value =    response.hra_f7;
          ma7.         current.value =    response.ma_f7;
       gross7.      current.value =    response.gross_f7;
        ptax7.       current.value =    response.ptax_f7;
        aupf7.       current.value =    response.aupf_f7;
          sf7.         current.value =    response.sf_f7;
      income7.     current.value =    response.income_f7;
      netsal7.     current.value =    response.netsal_f7;
       basic8.      current.value =    response.basic_f8;
        rate8.       current.value =    response.rate_f8;
          da8.         current.value =    response.da_f8;
         hra8.        current.value =    response.hra_f8;
          ma8.         current.value =    response.ma_f8;
       gross8.      current.value =    response.gross_f8;
        ptax8.       current.value =    response.ptax_f8;
        aupf8.       current.value =    response.aupf_f8;
          sf8.         current.value =    response.sf_f8;
      income8.     current.value =    response.income_f8;
      netsal8.     current.value =    response.netsal_f8;
       basic9.      current.value =    response.basic_f9;
        rate9.       current.value =    response.rate_f9;
          da9.         current.value =    response.da_f9;
         hra9.        current.value =    response.hra_f9;
          ma9.         current.value =    response.ma_f9;
       gross9.      current.value =    response.gross_f9;
        ptax9.       current.value =    response.ptax_f9;
        aupf9.       current.value =    response.aupf_f9;
          sf9.         current.value =    response.sf_f9;
      income9.     current.value =    response.income_f9;
      netsal9.     current.value =    response.netsal_f9;
  
       basic10.      current.value =    response.basic_f10;
        rate10.       current.value =    response.rate_f10;
          da10.         current.value =    response.da_f10;
         hra10.        current.value =    response.hra_f10;
          ma10.         current.value =    response.ma_f10;
       gross10.      current.value =    response.gross_f10;
        ptax10.       current.value =    response.ptax_f10;
        aupf10.       current.value =    response.aupf_f10;
          sf10.         current.value =    response.sf_f10;
      income10.     current.value =    response.income_f10;
      netsal10.     current.value =    response.netsal_f10;
       basic11.      current.value =    response.basic_f11;
        rate11.       current.value =    response.rate_f11;
          da11.         current.value =    response.da_f11;
         hra11.        current.value =    response.hra_f11;
          ma11.         current.value =    response.ma_f11;
       gross11.      current.value =    response.gross_f11;
        ptax11.       current.value =    response.ptax_f11;
        aupf11.       current.value =    response.aupf_f11;
          sf11.         current.value =    response.sf_f11;
      income11.     current.value =    response.income_f11;
      netsal11.     current.value =    response.netsal_f11;
       basic12.      current.value =    response.basic_f12;
        rate12.       current.value =    response.rate_f12;
          da12.         current.value =    response.da_f12;
         hra12.        current.value =    response.hra_f12;
          ma12.         current.value =    response.ma_f12;
       gross12.      current.value =    response.gross_f12;
        ptax12.       current.value =    response.ptax_f12;
        aupf12.       current.value =    response.aupf_f12;
          sf12.         current.value =    response.sf_f12;
      income12.     current.value =    response.income_f12;
      netsal12.     current.value =    response.netsal_f12;
       basic13.      current.value =    response.basic_f13;
        rate13.       current.value =    response.rate_f13;
          da13.         current.value =    response.da_f13;
         hra13.        current.value =    response.hra_f13;
          ma13.         current.value =    response.ma_f13;
       gross13.      current.value =    response.gross_f13;
        ptax13.       current.value =    response.ptax_f13;
        aupf13.       current.value =    response.aupf_f13;
          sf13.         current.value =    response.sf_f13;
      income13.     current.value =    response.income_f13;
      netsal13.     current.value =    response.netsal_f13;
    
    //   gas.current.value = response.gas_f;
    
      gas.current.value = response.gas_f;
      lpt.current.value = response.lpt_f;
      laupf.current.value = response.laupf_f;
      ltds.current.value = response.ltds_f;
      nas.current.value = response.nas_f;
  ...
  const navigate = useNavigate();
   const SubmitHandler =async(currentState)=>{
    const id = params.id;
    // const currentState="chapter";
    if(pdf!==null){
      UploadFile()
    }
   const res = await dispatch(Form12BHanlder(id,
   ...
   const PreviousHandler =async()=>{
     const res = await SubmitHandler("salary");
     if(res===true){
        navigate(`/salary/${params.id}`)
     }
   }
  ...
  const SelectHandler = async(e)=>{
   ...
   const AtHandler =( )=>{
  let value = document.getElementById('arrear_opt').value;
    ...
    const twoDigit =(num)=>{
     ...
     const net_arrear_fun =()=>{
      ...
      const basic =(e, val)=>{
        ...
        let gross = parseInt(basicc) + parseInt(da )+ parseInt(hra) + parseInt(ma);
        let gross2 = parseInt(basic2) + parseInt(da2)+ parseInt(hra2) + parseInt(ma2) ;
        let gross_val = parseInt(gross);
        let gross_val2;
        if(val>4) gross_val2 = parseInt(gross2);
      
      
        let p_tax, p_tax2, p_taxv, p_taxv2; 
        ...
        let netsal_val = parseInt(gross_val) - parseInt(p_taxv) - parseInt(aupf) - parseInt(sf) - parseInt(income);
        let netsal_val2 = parseInt(gross_val2) - parseInt(p_taxv2) - parseInt(aupf2) - parseInt(sf2) - parseInt(income2);
        ...
        if(val<=4){
            for(let i=val; i<=12; i++){
                ...
                document.getElementById(`epf${i}`).value = aupf;
                document.getElementById(`income${i}`).value = income;
                ...
                if(i>4){
                    ...
                    document.getElementById(`epf${i}`).value = aupf2;
                    document.getElementById(`income${i}`).value = income2;
        ...
        let t_basic=basicc, t_da=0,t_rate=0, t_hra=0, t_ma=0, t_gross=0, t_p_tax=0, t_aupf=0, t_sf=0, t_income=0, t_net_salary=0;
        ...
        document.getElementById('epf13').value = t_aupf;
      ...
      const da_Rate=(e,val)=>{
        ...
        let t_basic=0, t_da=0,t_rate=rate, t_hra=0, t_ma=0, t_gross=0, t_p_tax=0, t_aupf=0, t_sf=0, t_income=0, t_net_salary=0;
      ...
      const hra_fun=(e,val)=>{
        ...
        let t_basic=0, t_da=0,t_rate=0, t_hra=0, t_ma=0, t_gross=0, t_p_tax=0, t_aupf=0, t_sf=0, t_income=0, t_net_salary=0;
